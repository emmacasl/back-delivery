...
from delivery.views import DashboardView, MenusView, ProductosView, OrdenesCompraView, MenuEditarView
from delivery.views import listado_productos, listado_menus, listado_pedido, ProductoCrearView, \
    MenuCrearView, ProfuctoEditarView
